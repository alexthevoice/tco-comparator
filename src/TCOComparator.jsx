  ...
  return (
    <div className="container">
      ...
      <form>
        ...
        <label>Assicurazione (€): <input type="number" name="insurance" value={form.insurance} onChange={handleChange} /></label>
        <label>Bollo (€): <input type="number" name="tax" value={form.tax} onChange={handleChange} /></label>
        <label>Manutenzione (€): <input type="number" name="maintenance" value={form.maintenance} onChange={handleChange} /></label>
        <label>Carburante / energia (€): <input type="number" name="fuel" value={form.fuel} onChange={handleChange} /></label>
        <label>Pneumatici (€): <input type="number" name="tires" value={form.tires} onChange={handleChange} /></label>
        <label><input type="checkbox" name="isBusiness" checked={form.isBusiness} onChange={handleChange} /> Cliente Business</label>
      </form>
      <div className="results">
        <p><strong>TCO Acquisto:</strong> €{tcoPurchase.toFixed(2)}</p>
        <p><strong>TCO Noleggio:</strong> €{tcoRental.toFixed(2)}</p>
        <p><strong>Differenza:</strong> €{diff.toFixed(2)}</p>
